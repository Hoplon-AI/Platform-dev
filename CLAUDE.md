...
DEV_MODE=true ./venv_local/bin/uvicorn backend.main:app --reload --port 8000

# Run all tests
./venv_local/bin/pytest tests/ -v

# Run single test file
./venv_local/bin/pytest tests/test_silver_processor.py -v

# Run specific test
./venv_local/bin/pytest tests/test_silver_processor.py::TestParseS3KeyForMetadata -v
```
